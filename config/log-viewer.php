...
return [
    ...
    */
    ...
    'require_auth_in_production' => env('APP_ENV') === 'production' && env('LOG_VIEWER_PASSWORD', null) === null,

    'production' => [
        'user' => env('LOG_VIEWER_USER', 'admin'),
        'password' => env('LOG_VIEWER_PASSWORD', null),
    ],
